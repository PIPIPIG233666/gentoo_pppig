...
if [[ ${PV} == *9999 ]] ; then
	inherit git-r3
	EGIT_REPO_URI="https://github.com/ROCmSoftwarePlatform/hipSOLVER.git"
	S="${WORKDIR}/${P}"
else
	SRC_URI="https://github.com/ROCmSoftwarePlatform/hipSOLVER/archive/rocm-${PV}.tar.gz -> hipSOLVER-${PV}.tar.gz"
